    ...
    <header>
        <router-link to="/"><svg xmlns="http://www.w3.org/2000/svg" width="336" height="114" fill="none"
                ...
                <defs>
                    ...
                    <linearGradient id="paint1_linear" x1="171.5" x2="171.5" y1="19" y2="97"
        ...
        <input type="text" name="search" id="search" v-model="searchQuery" placeholder="Search for something...">
        <div class="header-tabs"><select v-model="lang" name="lang" id="lang">
                <option value="null" disabled>Select your preferred display language</option>
            ...
            <div class="menu">
                <mdicon name="menu" size="40"></mdicon>
            </div>
        </div>
    </header>
</template>
